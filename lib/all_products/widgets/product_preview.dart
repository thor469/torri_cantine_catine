...
import '../product_score/Product_score_cubit.dart';
                                ...
                                children: [
                                  ...
                                  !containsBioTag(widget.tags ?? [])
                                      ? Container(
                                          ...
                                          child: BlocProvider<
                                              ProductPointsCubit>.value(
                                            value: productPointsCubit,
                                            child: Center(
                                              child: BlocBuilder<
                                                  ProductPointsCubit,
                                                  ProductPointsState>(
                                                builder: (context, state) {
                                                  if (state.isLoading) {
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: Center(
                                                        child: Text(
                                                          '+ ${state.productPoints} pt', // Display the fetched product points
                                                          style: TextStyle(
                                                            color: Colors.white,
                                                            fontSize: 9,
                                                            fontWeight:
                                                      ...
                                                      null) {
                                                    return Text(
                                                      'Error: ${state.error}', // Display error message
                                                      style: TextStyle(
                                                          color: Colors.red,
                                                          fontSize: 9),
                                                    );
