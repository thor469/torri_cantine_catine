...
class _CompleteOrderScreenState extends State<CompleteOrderScreen> {
  ...
  Future<void> initCart() async{
    if(moneyDiscount >= 5.0){
      taxedTotalItems =(int.tryParse((widget.cart?.totals.totalItems ?? "0"))! + int.tryParse(widget.cart?.totals.totalItemsTax ?? "0")! - 500).toString();
    }else{
      taxedTotalItems =(int.tryParse((widget.cart?.totals.totalItems ?? "0"))! + int.tryParse(widget.cart?.totals.totalItemsTax ?? "0")! ).toString();
    }
                        ...
                        children: [
                                ...
                                return Column(
                                  children: [
                                    (widget.cart?.coupons?.isEmpty ?? false)
                                        ? const SizedBox()
                                        : Container(
                                      height: (widget.cart?.coupons?.length ?? 0) * 34,
                                      ...
                                      child: ListView.builder(
                                        ...
                                        shrinkWrap: true,
                                        itemCount: widget.cart?.coupons?.length ?? 0,
                                        itemBuilder: (context, index) {
                                          final couponItem = widget.cart!.coupons![index];
                                          return Container(
                          ...
                          model.billing.isEmpty
                            ...
                            child: PrimaryButton(
                              ...
                              ontap: () {
                                MainNavigation.push(context, MainNavigation.newAddressFromAccount(customerId, true , false, null, "completeorder", true, widget.totPoint, widget.cart));
                              },
                            ),
                          )
                              :
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              onTap: () {
                                                MainNavigation.push(context, MainNavigation.newAddressFromAccount(customerId, true, false, model.billing[index], 'completeorder', false, widget.totPoint, widget.cart));
                                              },
                                            ),
                                          ),
                                        ],
                          ...
                          model.shipping.isEmpty
                              ...
                              child: PrimaryButton(
                                ...
                                ontap: () {
                                  MainNavigation.push(context, MainNavigation.newAddressFromAccount(customerId, false,true, null,'completeorder', true, widget.totPoint,  widget.cart));
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              onTap: () {
                                                MainNavigation.push(context, MainNavigation.newAddressFromAccount(customerId, false, true, model.shipping[index], 'completeorder', false, widget.totPoint,  widget.cart));
                                              },
                                            ),
                                          ),
                                        ],
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (context,index){
                                            ...
                                            pgDescr = removeAllHtmlTags(
                                                pgDescr);
                                            amountCart = int.parse(widget.cart?.totals.totalPrice??'0');
