                        ...
                        children: [
                          TextSpan(
                            ...
                            recognizer: TapGestureRecognizer()..onTap = () {
                              ...
                              context.router.replace(MyOrdersRoute(fromMenu: true, fromAccount: false, fromThankScreen: false, fromOrderDetails: false));
                            },
                          ),
                          const TextSpan(
                            text: '.',
                                  ...
                                  child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            onTap: () =>
                                                context.router.push(OrderDetailRoute(order: orders.orders![index],)
                                                ),
                                            child: Row(
                                              children: [
                                                Text(
