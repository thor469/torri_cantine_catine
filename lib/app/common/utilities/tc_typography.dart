...
extension TCTypography on TextTheme {
  ...
  TextStyle get text_22 =>
      GoogleFonts.lato(fontStyle: FontStyle.normal, fontSize: 22);
  ...
  TextStyle get text_22_bold => GoogleFonts.lato(
      fontStyle: FontStyle.normal, fontSize: 22, fontWeight: FontWeight.w900);
